...
def processing_trajectory(P1, P2, yolo_pose_model, yolo_tennis_ball_model, video_side, video_45, knn_dataset):
    ...
    # 從側面影片與 45° 影片中分別提取 2D 軌跡
    with concurrent.futures.ThreadPoolExecutor() as executor:
        # 提交兩個任務同時執行
        future_side = executor.submit(analyze_trajectory, yolo_pose_model, yolo_tennis_ball_model, video_side)
        future_45 = executor.submit(analyze_trajectory, yolo_pose_model, yolo_tennis_ball_model, video_45)
...
if __name__ == "__main__":
    ...
    P1 = np.array([
        [  972.503666,     0.000000,   948.311745,     0.000000],
        [    0.000000,   972.177820,   494.156084,     0.000000],
        [    0.000000,     0.000000,     1.000000,     0.000000],
    ])

    P2 = np.array([
        [  775.784172,    47.567885,  1101.082373, -391761.335237],
        [ -128.565280,   981.395087,   451.043100, 66017.500403],
        [   -0.193626,     0.009541,     0.981029,    99.002060],
    ])
    ...
    for i in range(1, 4):
        video_side = f'trajectory/far__trajectory/trajectory__{i}/far__{i}_side.mp4'
        video_45 = f'trajectory/far__trajectory/trajectory__{i}/far__{i}_45.mp4'
