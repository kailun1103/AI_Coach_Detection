...
for i in range(89):
    ...
    ChessImaLF = cv2.imread(f'binocular_correction/indoor_0225/45/Indoor_{i}.JPG', 0)
    ChessImaL = cv2.imread(f'binocular_correction/indoor_0225/side/Indoor_{i}.JPG', 0)
